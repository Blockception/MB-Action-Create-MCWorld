...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const command_1 = __nccwpck_require__(758);
const file_command_1 = __nccwpck_require__(106);
const utils_1 = __nccwpck_require__(365);
const os = __importStar(__nccwpck_require__(87));
...
System.register(["fs", "./Package", "./types/PackageContext"], function (exports_1, context_1) {
    "use strict";
    var fs, Package_1, PackageContext_1, corexp;
    var __moduleName = context_1 && context_1.id;
    async function Process(Context) {
        console.log("starting on: " + Context.Folder);
        let result = await Package_1.Package(Context);
    ...
    return {
        setters: [
            ...
            function (PackageContext_1_1) {
                PackageContext_1 = PackageContext_1_1;
            }
        ],
        execute: async function () {
            //Leave this be
            corexp = __nccwpck_require__(227);
            //Start code
            try {
